    ...
    <div className="min-h-screen bg-ash">
      ...
      <header className="h-14 flex items-center justify-between px-8 border-b border-surface-700">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-base font-semibold text-steel tracking-tight">LLM CONFIGURATION</h1>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="p-8 overflow-auto">
        <div className="max-w-2xl space-y-8">
          ...
          {/* LLM Provider */}
          <section className="p-4 bg-surface-800 border border-surface-700">
            <h3 className="text-sm font-mono text-steel-dim mb-4 flex items-center gap-2 tracking-wide">
              <Cpu className="w-4 h-4 text-copper" strokeWidth={1.5} />
              LLM PROVIDER
            </h3>
