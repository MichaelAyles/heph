...
export function GalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-ash">
      ...
      {/* Test Projects Banner */}
      <div className="bg-amber-500/10 border-b border-amber-500/20">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center gap-3">
            <FlaskConical className="w-5 h-5 text-amber-400 flex-shrink-0" strokeWidth={1.5} />
            <p className="text-sm text-amber-200">
              <span className="font-medium">These are test projects.</span>{' '}
              Final projects with 3D CAD previews expected in a few days.
            </p>
          </div>
        </div>
      </div>
