        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-ash px-3 text-steel-dim">or</span>
            </div>
          </div>

          <a
            href="/api/auth/workos"
            className="w-full flex items-center justify-center gap-2 px-6 py-3 font-medium bg-white text-gray-800 hover:bg-gray-100 transition-colors"
          >
